...
public class TruthVariable implements Formula, Comparable< TruthVariable > {
	/**
	 * Lookup tables for accessing the TruthVariable instances by either their ID or name.
	 */
	 ...
	 * @param index	The index of the newly constructed variable.
	 * @param name	The name of the newly constructed variable.
	 */
	 ...
	 * @param index	The ID of the requested TruthVariable.
	 * @return	The TruthVariable having this ID if such one exists, <code>null</code> otherwise.
	 */
	 ...
	 * @param name	The name of the requested {@link TruthVariable}.
	 * @return	The {@link TruthVariable} having this name is such one exists, <code>null</code> otherwise.
	 */
	...
	/**
	 * Attempts to construct a {@link TruthVariable} having the given ID and name.
	 * @param index	The ID of the newly constructed instance.
	 * @param name	The name of the newly constructed instance.
	 * @return	<code>true</code> if neither the ID nor the name were used before,
	 * 	in which case a new instance is constructed with the specified parameters.
	 *  Otherwise, returns <code>false</code> and no new instance is constructed. 
	 */
	public static boolean registerVariable( int index, String name ){
		if( lookupTableInt.containsKey( index )) return false;
		if( lookupTableString.containsKey( name )) return false;
	...
	/**
	 * hashCode is the ID of the variable
	 * TODO after implementing serialization this method can be safely removed
	 */
	public int hashCode(){ return varIndex; }
	/**
	 * Two TruthVariables are equal iff their ID is equal
	 * TODO after implementing serialization this method can be safely removed
	 */
	...
	public boolean equals( Object obj ){
		if( obj instanceof TruthVariable ) return equals((TruthVariable)obj);
		return false;
	}
	/**
	 ...
	 */
	@Override
	public Formula normalize(){ return this; }
	
	/**
	 * Method that attempts to register the instances (0,"p"), (1,"q"), ..., (6,"v").
	 * @see #registerVariable(int, String)
	 */
	public static void registerDefaults(){
		for( int i = 0; i < 7; i++ ) registerVariable( i, Character.toString((char)('p'+i)));
	}
}
