...
public class Test {
	public static void main(String[] args) {
		...
		Formula test = new CompoundFormula( BinaryConnective.IMPLIES, new Formula[]{
				new CompoundFormula( AssociativeConnective.AND, new Formula[]{
						TruthVariable.getVariable("q"),
						new CompoundFormula( BinaryConnective.IMPLIES, new Formula[]{
								TruthVariable.getVariable("s"),
								TruthVariable.getVariable("r")} )
				}),
				new CompoundFormula( UnaryConnective.NOT, new Formula[]{
						new CompoundFormula( AssociativeConnective.AND, new Formula[]{
